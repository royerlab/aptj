...
/**
 * Wrapper for library <b>APTJ</b><br>
...
public class APTJLibrary {
	...
	/**
	 * Original signature : <code>long GetHWInfo(long, TCHAR*, long, TCHAR*, long, TCHAR*, long)</code><br>
	 * <i>native declaration : lib/APT/APTAPI.fixed.h:72</i>
	 */
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static long GetHWInfo(@org.bridj.ann.CLong long lSerialNum, Pointer<APTJLibrary.TCHAR > szModel, @org.bridj.ann.CLong long lModelLen, Pointer<APTJLibrary.TCHAR > szSWVer, @org.bridj.ann.CLong long lSWVerLen, Pointer<APTJLibrary.TCHAR > szHWNotes, @org.bridj.ann.CLong long lHWNotesLen) {
